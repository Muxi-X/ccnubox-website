      ...
      <div className="max-w-4xl mx-auto bg-white shadow sm:rounded-lg p-6 sm:p-10">
        ...
        <div className="space-y-6 text-gray-700 leading-relaxed">
          <div className="text-sm text-gray-500 mb-6">
            <p>发布及生效时间：2025年9月1日</p>
            <p>更新时间：2025年9月5日</p>
            <p>公司名称：择木而樨（武汉）网络技术有限公司</p>
            <p>
          ...
          <div className="bg-gray-100 p-4 rounded-md">
            <h3 className="font-bold mb-2">本隐私政策将帮助您了解以下内容</h3>
            <ul className="list-decimal list-inside space-y-1">
              <li>一、定义及适用范围</li>
              <li>二、我司如何收集和使用您的个人信息</li>
              <li>三、我司如何使用Cookie和同类技术</li>
              <li>四、我司如何共享、转让、公开披露您的信息</li>
              <li>五、我司如何保护、存储您的信息</li>
              <li>六、如何访问和管理自己的信息、信息安全</li>
              <li>七、其他</li>
            </ul>
          </div>
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <ul className="list-disc list-inside pl-4 space-y-1">
                <li>1. 根据相关法律法规的要求</li>
                <li>2. 根据用户的授权</li>
                <li>3. 根据本系统相关服务条款、应用许可使用协议的约定</li>
              </ul>
              <p>
                5.
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <p>3. 通过本系统所设cookies所取得的有关信息，将适用本政策</p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-2">
              ...
              <ul className="list-decimal list-inside space-y-1">
                ...
                <li>7. 其它本系统根据法律、法规或者网站政策认为合适的披露</li>
              </ul>
            </div>
          </section>
            ...
            <div className="space-y-4">
              ...
              <div className="mt-4">
                ...
                <ul className="list-decimal list-inside space-y-1">
                  ...
                  <li>
                    5.
                    个人常用设备信息（包括硬件型号、设备MAC地址、操作系统类型）
                  </li>
                  <li>
                    6. 软件列表唯一设备识别码（如IMEI/android
                    ID/IDFA/OPENUDID/GUID、SIM卡IMSI信息等在内的描述个人常用设备基本情况的信息，存在收集ICCID、Android
                    ID、IP、IMSI、SD卡数据、IMEI、安装列表、设备序列号、传感器、MAC、获取传感器信息、监听传感器、获取设备传感器、加速度传感器、剪切板的行为）
                  </li>
                </ul>
              </div>

              <div className="mt-4">
                <h3 className="font-bold mb-2">第三方SDK列表：</h3>
                <div className="space-y-4">
                  ...
                  <div className="bg-gray-50 p-3 rounded">
                    <p className="font-semibold">
                      2. SDK名称：支付宝小程序跳转；客户端SDK
                    </p>
                    <p>开发者: 支付宝(杭州)信息技术有限公司</p>
                    <p>作用：跳转支付宝小程序</p>
                    <p>
                      隐私政策链接：{' '}
                      <a
                  ...
                  <div className="bg-gray-50 p-3 rounded">
                    <p className="font-semibold">3. SDK名称：七牛云对象存储</p>
                    <p>所涉信息：横幅展示</p>
                    <p>用途：提供图片存储</p>
                    <p>SDK名称：图片 SDK</p>
                    <p>开发者: 上海七牛信息技术有限公司</p>
                    <p>
                      隐私链接：{' '}
                      <a
          ...
          <section>
            ...
            <div className="space-y-4">
              <div>
                <h3 className="font-semibold">1. 本地数据信息安全</h3>
                <p>
              ...
              <div>
                <h3 className="font-semibold">2. 服务器数据安全</h3>
                <p>
              ...
              <div>
                <h3 className="font-semibold">3. 服务器数据与个人信息的关联</h3>
                <p>我们不会主动收集您的个人信息并与之相关联。</p>
              </div>
              <div>
                <h3 className="font-semibold">4. 账号注销</h3>
                <p>
                  您可以通过点击“其他”——“注销”，输入登录密码，进行注销账号操作。账号注销后，我们将对已经收集的个人信息进行删除或匿名化处理。
                </p>
              </div>
              <div>
                <h3 className="font-semibold">5. 您能做什么？</h3>
                <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-4">七、其他</h2>
            <div className="space-y-4">
              <p>
                1.
              ...
              <div className="bg-blue-50 p-4 rounded-md">
                <h3 className="font-bold mb-2">3. 联系我们</h3>
                <p>
                  如果您对本隐私政策有任何意见或问题，或者您对我们收集、使用或披露您的个人信息有任何问题，请通过发送邮件至官方邮箱(
                  <a
                    href="mailto:muxistudio@qq.com"
                    className="text-blue-600 hover:underline"
                  >
                    muxistudio@qq.com
                  </a>
