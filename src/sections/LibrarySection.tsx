...
const LibrarySection = () => {
  // 彩色图标数据
  const iconBoxes = [
    { color: 'from-red-400 to-red-600', size: 'w-[198px] h-[196px]', position: 'top-[280px] left-[243px]' },
    { color: 'from-blue-400 to-blue-600', size: 'w-[220px] h-[214px]', position: 'top-[66px] left-[441px]' },
    { color: 'from-green-400 to-green-600', size: 'w-[154px] h-[147px]', position: 'top-[115px] left-[777px]' },
    { color: 'from-yellow-400 to-yellow-600', size: 'w-[125px] h-[120px]', position: 'top-[101px] left-[1001px]' },
    { color: 'from-purple-400 to-purple-600', size: 'w-[101px] h-[98px]', position: 'top-[-1px] left-[699px]', opacity: 'opacity-50' },
    { color: 'from-indigo-400 to-indigo-600', size: 'w-[101px] h-[98px]', position: 'top-[26px] left-[323px]', opacity: 'opacity-25' },
    { color: 'from-pink-400 to-pink-600', size: 'w-[187px] h-[185px]', position: 'bottom-[114px] left-[49px]' },
    { color: 'from-teal-400 to-teal-600', size: 'w-[130px] h-[124px]', position: 'top-[342px] left-[618px]', opacity: 'opacity-25' },
  ]
  ...
  return (
    <section className="relative h-[800px] bg-white overflow-hidden">
      ...
      <div className="absolute top-[-62px] left-[-122px] w-[1243px] h-[720px]">
        <svg viewBox="0 0 1243 720" className="w-full h-full stroke-[#8B7AE7] stroke-[56px] fill-none">
      ...
      <div className="absolute top-[24px] left-[14px] w-[309px] h-[274px] opacity-60">
        <svg viewBox="0 0 309 274" className="w-full h-full stroke-[rgba(139,122,231,0.64)] stroke-[20px] fill-none">
          {/* 网络节点连接线 */}
